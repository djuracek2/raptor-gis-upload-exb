...
const resources = require('./resources-c2b4175e.js');
...
const TableCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("td", { "aria-disabled": this.disabled, class: {
            ...
            ref: (el) => (this.containerEl = el) }, index.h("span", { "aria-hidden": true, "aria-live": this.focused ? "polite" : "off", class: CSS$1.assistiveText }, (this.selectionCell || this.readCellContentsToAT) && (index.h(index.Fragment, null, this.selectionCell && this.selectionText, this.readCellContentsToAT && !this.selectionCell && this.contentsText))), index.h("slot", { onSlotchange: this.updateScreenReaderContentsText })))));
    }
