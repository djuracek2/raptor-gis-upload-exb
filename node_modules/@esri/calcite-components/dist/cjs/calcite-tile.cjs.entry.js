...
const Tile = class {
    ...
    renderTile() {
        ...
        return (index.h("div", { class: { [CSS.container]: true, [CSS.largeVisual]: isLargeVisual } }, icon && index.h("calcite-icon", { flipRtl: iconFlipRtl, icon: icon, scale: "l" }), index.h("div", { class: CSS.contentContainer }, index.h("div", { class: { [CSS.contentSlotContainer]: hasContentStart } }, index.h("slot", { name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange })), index.h("div", { class: CSS.content }, heading && index.h("div", { class: CSS.heading }, heading), description && index.h("div", { class: CSS.description }, description)), index.h("div", { class: { [CSS.contentSlotContainer]: hasContentEnd } }, index.h("slot", { name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange })))));
    }
    render() {
        const { disabled } = this;
