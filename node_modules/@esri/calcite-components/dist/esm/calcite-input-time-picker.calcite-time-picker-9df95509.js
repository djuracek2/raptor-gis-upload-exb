 ...
 * v2.5.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-a8ffce66.js';
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-48bdc344.js';
import { g as guid } from './guid-cc244ce6.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction, I as InteractiveContainer } from './interactive-8ec04fb9.js';
import { n as numberKeys } from './key-412bf44e.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-f76c866a.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-f0bba14f.js';
import { n as numberStringFormatter, e as getDateTimeFormat, i as isValidNumber, b as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-be98a84a.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-f8ae5c2d.js';
import { d as decimalPlaces, g as getDecimals } from './math-0f85cb27.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-eb41bc7f.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-9520e134.js';
import { g as getIconScale } from './component-c278e912.js';
import { V as Validation } from './Validation-b481231d.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => import('./ar-daa22e2e.js')],
    ["bg", () => import('./bg-23c0f92b.js')],
    ["bs", () => import('./bs-58007ab5.js')],
    ["ca", () => import('./ca-58525b13.js')],
    ["cs", () => import('./cs-1be1e148.js')],
    ["da", () => import('./da-cadd8c18.js')],
    ["de", () => import('./de-e4202fae.js')],
    ["de-at", () => import('./de-at-9bdb7685.js')],
    ["de-ch", () => import('./de-ch-a53b0bb4.js')],
    ["el", () => import('./el-55aaeb31.js')],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => import('./en-au-b7f8ea50.js')],
    ["en-ca", () => import('./en-ca-ef3289b7.js')],
    ["en-gb", () => import('./en-gb-9bd7b184.js')],
    ["es", () => import('./es-c08b5b16.js')],
    ["es-mx", () => import('./es-mx-b5e2043e.js')],
    ["et", () => import('./et-0b0e07c3.js')],
    ["fi", () => import('./fi-fc9a22bd.js')],
    ["fr", () => import('./fr-c9276d9f.js')],
    ["fr-ch", () => import('./fr-ch-638ba0df.js')],
    ["he", () => import('./he-42249d21.js')],
    ["hi", () => import('./hi-2d7a7de5.js')],
    ["hr", () => import('./hr-11ec73ae.js')],
    ["hu", () => import('./hu-2d8fdeb3.js')],
    ["id", () => import('./id-3085d622.js')],
    ["it", () => import('./it-f6184b31.js')],
    ["it-ch", () => import('./it-ch-19fe43d5.js')],
    ["ja", () => import('./ja-ba7344ed.js')],
    ["ko", () => import('./ko-1f63b035.js')],
    ["lt", () => import('./lt-c0c343ed.js')],
    ["lv", () => import('./lv-36c5a2d3.js')],
    ["mk", () => import('./mk-b95d8548.js')],
    ["nl", () => import('./nl-6858c662.js')],
    ["nb", () => import('./nb-d7db6e9b.js')],
    ["pl", () => import('./pl-4dba29ae.js')],
    ["pt", () => import('./pt-179bb4e5.js')],
    ["pt-br", () => import('./pt-br-d63d2c15.js')],
    ["ro", () => import('./ro-9dc1ff79.js')],
    ["ru", () => import('./ru-634dde4f.js')],
    ["sk", () => import('./sk-ae0c3d48.js')],
    ["sl", () => import('./sl-20ecc0d9.js')],
    ["sr", () => import('./sr-31ad757b.js')],
    ["sv", () => import('./sv-a0aafa76.js')],
    ["th", () => import('./th-44aab1cd.js')],
    ["tr", () => import('./tr-f8182709.js')],
    ["uk", () => import('./uk-39bf4619.js')],
    ["vi", () => import('./vi-f4f3a963.js')],
    ["zh-cn", () => import('./zh-cn-4114a165.js')],
    ["zh-hk", () => import('./zh-hk-392cea24.js')],
    ["zh-tw", () => import('./zh-tw-99624de6.js')],
]);
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-9df95509.js.map