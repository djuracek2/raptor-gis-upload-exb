...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-8ec04fb9.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-be98a84a.js';
    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                import('./index-2ba8c59c.js'),
                import('./index-b20ef9ff.js'),
            ]);
        }
