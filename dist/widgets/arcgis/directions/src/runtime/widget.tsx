/** @jsx jsx */
import { React, jsx, css, type AllWidgetProps, DataSourceManager, DataSourceStatus, type FeatureLayerDataSource, dataSourceUtils, type UseUtility, UtilityManager, getAppStore, hooks, MutableStoreManager, ReactRedux, type IMState, ServiceManager, type ResourceSessions, proxyUtils } from 'jimu-core'
