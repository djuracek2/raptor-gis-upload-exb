...
import {
  ...
  type DataSource, type FeatureLayerDataSource, getAppStore, appConfigUtils, type IMState, type Timezone
...
export default class Widget extends React.PureComponent<WidgetProps, WidgetState> {
  ...
  render () {
    ...
    if (this.props.config.useMapWidget ? !useMapWidget : !useDataSource) {
      ...
      if ((this.currentData?.count > 1 || enableDataAction) && this.state.loadDataStatus === DataSourceStatus.Loaded) {
        headerConten = (
