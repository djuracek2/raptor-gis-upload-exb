...
export default class Chart extends React.PureComponent<Props, IState> {
            ...
            this.createDataForIntersectingAssets(allElevations).then(() => {
              ...
              this.setState({
                ...
                if (this.chart) {
                  ...
                  this.accessChartParams.chart.zoomOutButton.get('background').set('fill', colorAm5(this.props.theme.colors.palette.primary[600]))
  ...
  configureCursorAM5 = ({ chart, xAxis, yAxis, params }) => {
    ...
    chartTooltip.get('background')?.setAll({
      fill: colorAm5(params.exbTheme.colors.white),
      strokeWidth: 0.5,
      stroke: colorAm5(params.exbTheme.colors.palette.light[800]),
      fillOpacity: 1
    })
  ...
  setZoomButton = (chart, zoomOutTooltipText: string, theme) => {
    ...
    zoomTooltip.get('background')?.setAll({
      fill: colorAm5(theme.colors.palette.primary[600]),
      fillOpacity: 0.6
    })
    ...
    chart.zoomOutButton.get('background').setAll({
      fill: colorAm5(theme.colors.palette.primary[600]),
      stroke: colorAm5(theme.colors.palette.primary[600])
    })
    chart.zoomOutButton.get('background').states.create('hover', {}).setAll({
      fill: colorAm5(theme.colors.palette.primary[500]),
      stroke: colorAm5(theme.colors.palette.primary[500])
    })
    chart.zoomOutButton.get('background').states.create('down', {}).setAll({
      fill: colorAm5(theme.colors.palette.primary[800]),
      stroke: colorAm5(theme.colors.palette.primary[800])
    })
  }
  ...
  */
  ...
  configureXAxis = (ctx) => {
    ...
    tooltip.get('background')?.setAll({
      fill: colorAm5(params.exbTheme.colors.black),
      stroke: undefined
    })
