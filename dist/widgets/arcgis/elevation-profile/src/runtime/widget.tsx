...
/** @jsx jsx */
import { React, type AllWidgetProps, BaseWidget, jsx, classNames, getAppStore, WidgetState, AppMode, type IMState, type DataRecord, DataSourceManager, DataSourceStatus, type FeatureLayerQueryParams, type QueriableDataSource, type DataSource, geometryUtils, DataSourceSelectionMode } from 'jimu-core'
import {
    ...
    sketchVM.on('create', event => {
      if (event.state === 'start') {
        ...
        if (this.state.selectModeActive) {
          ...
          jmv.selectFeaturesByGraphic(event.graphic, 'intersects', DataSourceSelectionMode.New, true).then((featuresByLayer) => {
