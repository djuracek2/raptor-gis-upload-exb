/** @jsx jsx */
import { React, jsx, css, classNames, type DataSource, type ImmutableObject, type IMState, type IMSqlExpression, type FeatureLayerDataSource, ReactRedux, hooks, DataSourceManager } from 'jimu-core'
      ...
      <div className='query-form' css={getFormStyle(isAutoHeight)}>
        <div className='query-form__content my-2'>
          ...
          {showAttributeFilter && showSpatialFilter && (
            <hr className='m-4' css={css`border: none; height: 1px; background-color: var(--light-300);`}/>
          )}
          {showSpatialFilter && (
