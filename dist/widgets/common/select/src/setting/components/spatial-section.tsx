/** @jsx jsx */
import {
  React, jsx, css, hooks, Immutable, type ImmutableArray, type ImmutableObject, DataSourceTypes,
...
const SUPPORTED_TYPES = Immutable([DataSourceTypes.FeatureLayer, DataSourceTypes.SceneLayer])
    ...
    >
      ...
      >
        <TitleWithSwitch
          ...
          className='setting-text-level-2 mt-4'
