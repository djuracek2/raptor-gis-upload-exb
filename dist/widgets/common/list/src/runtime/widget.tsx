  ...
  renderList = (ds?: QueriableDataSource, dsInfo?: IMDataSourceInfo) => {
    ...
    return (
      ...
      >
        ...
        {/* render data count */}
        {config.showRecordCount && this.renderDataCount(ds)}
