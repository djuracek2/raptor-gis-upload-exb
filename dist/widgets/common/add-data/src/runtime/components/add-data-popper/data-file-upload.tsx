    ...
    <div className='mt-4 drag-area-container'>
      <Label for={dragToUploadBtnId} className='drag-area text-center'>
        ...
        <div className='upload-btn-container w-75' title={translate('upload')}>
          <Label for={clickToUploadBtnId} className='upload-btn text-center mt-4 mb-0 text-truncate' css={uploadInputFocused ? css`outline: ${polished.rem(2)} solid ${theme.colors.palette.primary[700]}` : ''}>
