...
const SuggestionList = (props: SearchSettingProps) => {
  ...
  const { className, reference, searchSuggestion, isOpen, searchText, canUseOutoutDsLength, id, searchInputRef, openUtilityErrRemindInSuggestion, serviceList, toggleSuggestionUtilityError, toggel, onRecordItemClick, setSuggestionFirstItem } = props
