...
export default class MapSearch {
  ...
  public static searchInfo: MapSearchData = undefined
  ...
  public static registerCallbacks (
    ...
    let mapData = MapSearch.mapData[mapWidgetId]
    ...
    if (!mapData) {
      ...
      MapSearch.mapData[mapWidgetId] = mapData
    }

    mapData.widgets.push(myWidgetInfo)
    ...
    mapData.searchControl.container.style.marginRight = '40px' // move search control to left to make room for other widgets
